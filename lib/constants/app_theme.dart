...
abstract class AppSpacing {
  ...
  static final Decoration whiteBox = BoxDecoration(color: Colors.white, borderRadius: defaultM);
...
abstract class TextStylings {
  static const TextStyle titleWhite = TextStyle(fontSize: 25, color: Colors.white);
  static const TextStyle titleBlue =
      TextStyle(fontSize: 25, color: Color.fromARGB(255, 22, 63, 92));
  ...
  static const TextStyle textDefaultBlue =
      TextStyle(fontSize: 16, color: Color.fromARGB(255, 22, 63, 92));
  ...
  static const TextStyle textSmallWhite = TextStyle(color: Colors.white, fontSize: 10);
